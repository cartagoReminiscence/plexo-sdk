...
use crate::{errors::sdk::SDKError, resources::members::member::Member};
...
impl JWTEngine {
    ...
    pub fn create_session_token(&self, member: &Member) -> Result<String, SDKError> {
    ...
    pub fn decode_session_token(&self, token: &str) -> Result<PlexoAuthTokenClaims, SDKError> {
